...
//eta manually evabe ekhn r kori na
class fontstyle{
  static TextStyle textStyle = TextStyle(
      color: Colors.yellow
  );
  static TextStyle labelstle = TextStyle();
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    label: Text('Email',style: Theme.of(context).textTheme.bodySmall),
                ...
                TextButton(
                 ...
                 // child: Text('btn', style: Theme.of(context).textTheme.bodyMedium,),
                  child: Text('btn', style: Theme.of(context).textTheme.bodyMedium,
                  ),),
